# Fork Instructions / Οδηγίες Fork

> Configure an independent fork of Save DedSec Project with your own Internet Archive credentials and archive identifiers.
>
> Ρύθμισε ένα ανεξάρτητο fork του Save DedSec Project με τα δικά σου Internet Archive credentials και archive identifiers.
